...
class PWPViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        get_data("http://cgi.soic.indiana.edu/~team10/bettingHistory.php")
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "bhcell", for: indexPath) as! BettingHistoryTableViewCell
